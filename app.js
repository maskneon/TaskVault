...
// mongoose.connect("mongodb://0.0.0.0/listDB",{useNewUrlParser: true,});
mongoose.connect("mongodb+srv://admin-yash:todo123@myworkdb.tjainrj.mongodb.net/?retryWrites=true&w=majority", {useNewUrlParser: true,});
const itemsSchema={
    name:String
};
